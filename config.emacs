...
(use-package multi-term
  :ensure t)                    ;; manage multiple terminals from emacs
...
(use-package flycheck                 ;; syntax check
  ...
  (progn
    ...
    (setq-default flycheck-disabled-checkers '(coq c/c++-clang c/c++-gcc))
...
;; Emacs window split
(global-set-key (kbd "M-\"") (ignore-error-wrapper 'split-window-below))
(global-set-key (kbd "M-%") (ignore-error-wrapper 'split-window-right))
